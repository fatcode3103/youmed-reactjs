...
import styles from "./OptionBooking.module.scss";
...
function OptionBooking(props) {
    const { handleCompleteStep, getDataFromChildrenComponent, optionData } =
        props;
